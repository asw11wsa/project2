						...
						<td colspan="5">
							<ol class="paging">
								<c:choose>
									...
									<c:otherwise>
										<li><a href="${pageContext.request.contextPath}/web/adminqna/adminQnaList?cPage=${nowPage-pagePerBlock }">이전으로</a></li>
									</c:otherwise>
								</c:choose>
								...
								<c:choose>
									...
									<c:when test="${totalPage > (nowPage+pagePerBlock) }">
										<li><a href="${pageContext.request.contextPath}/web/adminqna/adminQnaList?cPage=${nowPage+pagePerBlock }">다음으로</a></li>
									</c:when>
									<c:otherwise>
										<li><a href="${pageContext.request.contextPath}/web/adminqna/adminQnaList?cPage=${totalPage }">다음으로</a></li>
									</c:otherwise>
								</c:choose>
							</ol>
						</td>
